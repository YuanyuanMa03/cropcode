...
const FILE_HISTORY_AUTHOR_NAME = "CropCode Checkpoint";
const FILE_HISTORY_AUTHOR_EMAIL = "cropcode-checkpoint@localhost";
const MANIFEST_PATH = ".cropcode-file-history.json";
