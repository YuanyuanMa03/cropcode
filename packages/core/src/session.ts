...
`;
  ...
  private loadProjectAgentInstructions(): { content: string; displayPath: string } | null {
    const candidatePaths = [
      {
        absolutePath: path.join(this.projectRoot, ".cropcode", "AGENTS.md"),
        displayPath: "./.cropcode/AGENTS.md",
      },
      {
  ...
  private loadAgentInstructions(): string | null {
    ...
    return this.readNonEmptyFile(path.join(os.homedir(), ".cropcode", "AGENTS.md"));
  }
