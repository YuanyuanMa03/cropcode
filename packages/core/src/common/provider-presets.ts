...
export const BUILTIN_PROVIDERS: ProviderPreset[] = [
  ...
  // ── 2. 智谱 GLM (Z.ai) ────────────────────────────────────
  {
    ...
    models: [
      ...
      },
      {
        ...
        outputPricePerMTok: 15.7,
        cacheHitPricePerMTok: 0.79,
        contextWindow: "128K",
        supportsThinking: true,
        defaultThinking: true,
        thinkingFormat: "deepseek",
  ...
  // ── 4. MiMo (小米) ──────────────────────────────────────────
  {
    ...
    pricingPage: "https://mimo.mi.com/docs/zh-CN/price/pay-as-you-go",
    topUpPage: "https://platform.xiaomimimo.com",
    freeTier: "新用户赠送额度，Token Plan 限时优惠 ¥14.9/月起",
    keyFormat: "sk-...",
    openaiCompatible: true,
    codingPlan: {
